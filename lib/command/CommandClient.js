...
/**
* Represents an TheDiscord client with the command framework
* @extends Client
...
class CommandClient extends Client {
    ...
    * @arg {Object} options TheDiscord options (same as Client)
    ...
    * @arg {String} [commandOptions.description="An TheDiscord-based Discord bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "An TheDiscord-based Discord bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
