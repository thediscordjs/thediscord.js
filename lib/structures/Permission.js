...
* [A full list of permission nodes can be found on the docs reference page](/TheDiscord/docs/reference)
*/
class Permission extends Base {
    ...
    * @arg {String | BigInt} permission The name of the permission, or bit of permissions. [A full list of permission nodes can be found on the docs reference page](/TheDiscord/docs/reference). Pass a BigInt if you want to check multiple permissions.
